...
if(JSON_TestDataDirectory)
    ...
    find_package(Git)
    # command to download test data
    add_custom_command(
        OUTPUT ${CMAKE_BINARY_DIR}/json_test_data
        COMMAND ${GIT_EXECUTABLE} clone -c advice.detachedHead=false --branch v${JSON_TEST_DATA_VERSION} ${JSON_TEST_DATA_URL}.git --quiet --depth 1
        COMMENT "Downloading test data from ${JSON_TEST_DATA_URL} (v${JSON_TEST_DATA_VERSION})"
        WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
    )
    # target to only download data once
    add_custom_target(download_test_data DEPENDS ${CMAKE_BINARY_DIR}/json_test_data)
